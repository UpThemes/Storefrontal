...
<table class="checkout_cart">
  ...
  <?php if(wpsc_uses_shipping()): ?>
   ...
   <?php do_action('wpsc_before_form_of_shopping_cart'); ?>
	...
	<?php endif; ?>	
	<form class='wpsc_checkout_forms form-holder' name="checkout_forms" action='<?php echo get_option('shopping_cart_url'); ?>' method='post' enctype="multipart/form-data">
...
<!-- div for make purchase button -->
      <div class='wpsc_make_purchase'>
         <span>
	       ...
	       <div class="row">
			<a href="#" onclick="checkout_forms.submit();return false;" class="make_purchase btn-add"><span><?php _e('Purchase', 'wpsc');?></span></a>
		</div>
	       <!--
