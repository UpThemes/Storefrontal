...
<body <?php body_class( get_theme_style() ); ?>>
	<div id="wrapper">
		<div id="header">
			<img class="print-logo" src="<?php bloginfo('template_url'); ?>/images/logo-storefrontal.png" width="253" height="57" alt="<?php bloginfo('description') ?>" />
