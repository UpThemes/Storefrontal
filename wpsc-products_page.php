	...
	<?php if(wpsc_display_products()): ?>
		...
		<?php if(wpsc_is_in_category()) : ?>
			<div class="wpsc_category_details">
				...
				<?php if(wpsc_category_description()) : ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<li class="default_product_display product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">   
				...
				<?php if(wpsc_show_thumbnails()) :?>
						...
						?>
							<a rel="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?> img-holder" href="<?php echo wpsc_the_product_image(); ?>">
								<img height="166" width="166" class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_thumbnail(); ?>" />
							</a>
						<?php else: ?>
		...
		</li><!--close default_product_display-->
